...
class AnsweringAgent(object):
    ...
    def build_prompt(self, question_data: Dict[str, str|Any]) -> Tuple[str, str]:
        ...
        tmpl = (
            ...
            'RESPONSE FORMAT: STRICTLY generate a valid JSON object as shown below. Make sure that the answer DOESNT contain anything apart from the correct optin alphabet:\n'
            '{{\n'
            '    "answer": "One of the letter from [A, B, C, D] corresponding to the choice of correct answer option",\n'
            '    "reasoning": "Brief explanation within 100 words"\n'
            '}}'

            'NOTE : DO NOT ADD ANY COMMENTRY TO THE RESPONSE. BE SPECIFIC ON WHAT IS INSTRUCTED.'
        )
